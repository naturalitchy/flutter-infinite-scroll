...
import 'package:infinite_scroll_example/home_screen.dart';
...
class MyHomePage extends StatefulWidget {
  ...
  String title = 'Scroll Notification Sample';
  @override
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // List<String> serverItems = List();
  List<String> serverItems = <String>[];
